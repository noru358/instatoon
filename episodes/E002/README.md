...
First real pilot after the INSTATOON_STYLE_v2.0 reset.
...
Current premise is a working anecdote-style pilot concept developed during the production session.

Do NOT claim a verified external/community source until an actual source URL/post is attached and recorded.

If later matched to a real source:
- add provenance;
- separate source facts/source voice;
- update public-treatment wording.

## 3. Story premise

During a blind date, the man asks to borrow Harin's phone.
She assumes he needs to make a call.
He opens Instagram, searches his own account, and follows himself from her account.
Harin internally wants to go home.
...
Male blind-date partner:
- episode-only character for E002.
...
Current 7-beat direction:

01 HOOK
“소개팅 하는데 갑자기 폰 좀 빌려달라는 거임”

02 REQUEST
Man asks:
“폰 잠깐만 빌려주실래요?”

03 HANDOFF / ASSUMPTION
Harin gives the phone.
Narration:
“전화하나 싶어서 걍 줬거든?”
...
05 SUSPICION
Harin realizes something is odd.
“설마 했는데”

06 REVEAL / PEAK
He follows himself from Harin's account.
Possible line:
“이제 안 까먹겠네요ㅎㅎ”

07 AFTERMATH / LANDING
Harin deadpan:
“아 집가고 싶다”
...
The user identified AI-like wording as a structural issue, so final wording uses:
SOURCE VOICE → DRAFT → HUMANIZATION → USER VOICE GATE.
...
Observed defects:
1. male solution drifted too close to Taemin/main-cast;
2. text too small and too detached as top narration;
...
The later retry improved:
- text size;
- speech-bubble visibility;
- clearer mobile typography.

But regressed:
- male face into a generic smooth AI-like design;
- character drawing;
- composition;
- scene construction;
- overall style/visual quality.
...
Apply larger editable vector:
- narration;
- speech bubbles;
- reaction text.

### Step D — sequence QC
Enforce slide_01 … slide_07 numeric order.
Verify reveal before aftermath.

## 10. Current publish state
